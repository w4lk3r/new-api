	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/invited-users", controller.GetSelfInvitedUsers)
				selfRoute.GET("/invitation-rewards", controller.GetSelfInvitationRewardRecords)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/invited-users", controller.GetInvitedUsers)
				adminRoute.GET("/:id/invitation-rewards", controller.GetInvitationRewardRecords)
				adminRoute.POST("/:id/invitation-rewards/clear", controller.ClearInvitationRewardQuota)
